...
public class  Condition_functionality extends Testbase{
	...
	public Condition_functionality  deleteCondition(String changedcname) throws Throwable
	{
	...
	public Condition_functionality  verify(String changedcname) throws Throwable
	{
		search.sendKeys(changedcname);
