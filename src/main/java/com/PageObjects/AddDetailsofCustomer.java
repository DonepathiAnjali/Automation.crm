package com.PageObjects;
	...
	public class AddDetailsofCustomer extends Testbase{

		public AddDetailsofCustomer() throws Throwable {
			super();
	    ...
	    WebElement save;
	    public AddDetailsofCustomer(WebDriver driver) throws Throwable
	    {
